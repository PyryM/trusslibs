...
local sdl2_root      = os.getenv("SDL2_DIR") or "/libraries/sdl2"
print("sdl2 root: ", sdl2_root)
local dxsdk_root     = os.getenv("DXSDK_DIR") and os.getenv("DXSDK_DIR") or "C:/Program Files (x86)/Microsoft DirectX SDK (June 2010)"
local portaudio_root = os.getenv("PORTAUDIO_DIR") or "/libraries/portaudio"
local openal_root    = os.getenv("OPENAL_DIR") or "/libraries/openal"
