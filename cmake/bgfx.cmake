...
elseif("${CMAKE_GENERATOR}" STREQUAL "Unix Makefiles")
    set(bgfx_CONFIGURE_COMMAND "${CMAKE_COMMAND}" -E env "BX_DIR=${bx_DIR}" "BIMG_DIR=${bimg_DIR}" "${bx_GENIE}${CMAKE_EXECUTABLE_SUFFIX}" --with-dynamic-runtime --with-min-tools --with-imgui --with-nanovg --with-shared-lib "--gcc=${bgfx_GENIE_GCC}" gmake)
